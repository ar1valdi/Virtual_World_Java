...
public class Consts {
    ...
    public static final int SHEEP_NUMBER=           10;
    public static final int WOLF_NUMBER=            10;
    public static final int FOX_NUMBER=             10;
    public static final int ANTELOPE_NUMBER=        10;
    public static final int TURTLE_NUMBER=          10;
    public static final int GRASS_NUMBER=           10;
    public static final int DANDELION_NUMBER=       10;
    public static final int GUARANA_NUMBER=         10;
    public static final int NIGHTSHADE_NUMBER=      10;
    public static final int PINE_BORSCH_NUMBER=     10;
